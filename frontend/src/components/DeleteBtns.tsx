...
function DeleteBtns({ onClick, dloading }: any) {
  console.log("delete exec", dloading);
  ...
  return (
    <div className="m-10 mt-20">
      ...
      >
        ...
        <div>
          <span className="font-medium">Caution:</span> Once deleted, this
          jotter cannot be recovered. Are you certain?
        </div>
      </div>
      <div>
        {!dloading ? (<button
        ...
        >
          <span className="text-[14px]">Delete Jotter </span>{" "}
          <span className="text-[16px]">
            {" "}
            <MdDelete />
          </span>
        </button>)
       : (<button disabled type="button" className="animate-pulse bg-red-800 text-red-100 font-medium rounded-lg text-sm px-4 py-2.5 text-center me-2 inline-flex items-center">
